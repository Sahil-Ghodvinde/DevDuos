      ...
      <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto">
          <div className="bg-white p-6 shadow-lg rounded-2xl">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Create an Account</h2>

            {/* Username Field - Required for all methods */}
            <div className="mb-6">
              ...
              <input
                ...
                className="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#1e1894] focus:border-[#1e1894] transition-all duration-200"
                required
                placeholder="Choose a unique username"
              />
              <p className="mt-1 text-xs text-gray-500">This username will be used across the platform</p>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                ...
                >
                  {showEmailSignup ? 'Hide email signup' : 'Sign up with email instead'}
                </button>
              </div>
            </div>
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-gray-600">
                ...
                <Link href="/login" className="font-medium text-[#1e1894] hover:text-[#1e1894]/80 transition-colors duration-200">
                  Sign in
                </Link>
              </p>
            </div>
      ...
      {showSuccessMessage && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-white p-6 rounded-2xl shadow-xl max-w-sm w-full">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Welcome to ProjectHackathon! 🎉</h3>
            <p className="text-gray-600 mb-4">
              Your account has been created successfully. We recommend completing your profile to get the most out of your experience.
            </p>
            <button
              onClick={() => setShowSuccessMessage(false)}
              className="w-full py-3 px-4 bg-[#1e1894] text-white rounded-xl font-medium hover:bg-[#1e1894]/90 transition-all duration-200"
            >
              Get Started
            </button>
          </div>
